...
export function buildStaticSuperposition(
  plugin: PluginContext,
  src: SuperpositionTestInput
) {
...
export function dynamicSuperpositionTest(
  plugin: PluginContext,
  src: string[],
  comp_id: string
) {
...
async function siteVisual(
  ...
  const surr = await plugin.builders.structure.tryCreateComponentFromExpression(
    s,
    rest,
    "rest"
  );
